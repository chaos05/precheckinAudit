...
class PrecheckinAudit:
    ...
    file_name_last_audit_main_runtime = "last_audit_main_runtime_time-stamp.json"
    file_name_last_audit_main_design_time = "last_audit_main_design_time_time-stamp.json"
    file_name_last_audit_224_runtime = "last_audit_224_runtime_time-stamp.json"
    file_name_last_audit_224_design_time = "last_audit_224_design_time_time-stamp.json"
    ...
    def __init__(self, testId, communityDesignOrRuntime, autoBuildName, requestedRunCount):
        ...
        self.url = PrecheckinAudit.apiEndPoint.format(testId=testId, requestedRunCount=requestedRunCount)
    ...
    def precheckinAudit(self):
        ...
        if ( self.communityDesignOrRuntime == PrecheckinAudit.communityRuntime and self.autoBuildName == PrecheckinAudit.autoBuildNameMain):
            self.file_name_latest_precheckin = PrecheckinAudit.file_name_last_audit_main_runtime
        elif ((self.communityDesignOrRuntime == PrecheckinAudit.communityDesignTime) and self.autoBuildName == PrecheckinAudit.autoBuildNameMain):
            self.file_name_latest_precheckin = PrecheckinAudit.file_name_last_audit_main_design_time
        elif ((self.communityDesignOrRuntime == PrecheckinAudit.communityRuntime) and self.autoBuildName == PrecheckinAudit.autoBuildName224Patch):
            self.file_name_latest_precheckin = PrecheckinAudit.file_name_last_audit_224_runtime
        elif ((self.communityDesignOrRuntime == PrecheckinAudit.communityDesignTime) and self.autoBuildName == PrecheckinAudit.autoBuildName224Patch):
            self.file_name_latest_precheckin = PrecheckinAudit.file_name_last_audit_224_design_time
        else:
            # add an error
            pass
...
commPrecheckinRuntimeMain = PrecheckinAudit(testIdCommRunTimeMain, PrecheckinAudit.communityRuntime, PrecheckinAudit.autoBuildNameMain, requestedRunCount)
commPrecheckinRuntimeMain.precheckinAudit()

commPrecheckinDesignTimeMain = PrecheckinAudit(testIdCommDesignTimeMain, PrecheckinAudit.communityDesignTime, PrecheckinAudit.autoBuildNameMain, requestedRunCount)
commPrecheckinDesignTimeMain.precheckinAudit()

commPrecheckinRuntime224Patch = PrecheckinAudit(testIdCommRunTime224Patch, PrecheckinAudit.communityRuntime, PrecheckinAudit.autoBuildName224Patch, requestedRunCount)
commPrecheckinRuntime224Patch.precheckinAudit()

commPrecheckinDesignTime224Patch = PrecheckinAudit(testIdCommDesignTime224Patch, PrecheckinAudit.communityDesignTime, PrecheckinAudit.autoBuildName224Patch, requestedRunCount)
